...
Middleware functions and express routing

- [ ] Describe Middleware?
Middleware functions can get the request and response objects, operate on them, and (when specified) trigger some action.

- [ ] Describe a Resource?
The fundamental concept in any RESTful API is the resource. A resource is an object of data of the same type. (ex. api/users) One endpoint per resource.

- [ ] What can the API return to help clients know if a request was successful?
status code 200.

- [ ] How can we partition our application into sub-applications?
By nesting routes inside of other routes.
